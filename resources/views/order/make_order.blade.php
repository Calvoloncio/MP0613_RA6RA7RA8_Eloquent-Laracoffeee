...
@section('content')
  <div class="container-fluid px-2 px-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" style="display:unset;">
                      <div class="input-group-prepend">
                        ...
                        @else
                          <span class="input-group-text">Rp. {{ ((100 - $product->discount) / 100) * $product->price }}
                            <span class="strikethrough ms-4">
                              {{ $product->price }}
                ...
                <div id="collapseCC" class="accordion-collapse collapse {{ old('payment_method') == 1 ? 'show' : '' }}"
                  ...
                  <div class="accordion-body">
                    ...
                    <div id="mandiri" class="form-check w-100 collapsed">
                      <span><img src="{{ asset('storage/icons/bank-mandiri.svg') }}" alt="mandiri logo"
                          width="40px"></span>
    ...
    ? 'checked' : '' }} style="appearance: none;">
                      <label for="bank_bri" class="colapse_pilih_bank" data-bs-toggle="collapse"
                        data-bs-target="#section_bri" aria-expanded="false" style="cursor: pointer;"
                        onclick="hideBankMessage()">Bank BRI</label>
    ...
    ? 'checked' : '' }} style="appearance: none;">
                      <label for="bank_bca" class="colapse_pilih_bank" data-bs-toggle="collapse"
                        data-bs-target="#section_bca" aria-expanded="false" style="cursor: pointer;"
                        onclick="hideBankMessage()">Bank BCA</label>
    ...
    ? 'checked' : '' }} style="appearance: none;">
                      <label for="bank_bni" class="colapse_pilih_bank" data-bs-toggle="collapse"
                        data-bs-target="#section_bni" aria-expanded="false" style="cursor: pointer;"
                        onclick="hideBankMessage()">Bank BNI</label>
                    ...
                    <div class="container mt-3" id="container-petunjuk">
                      <div class="mt-4">
                        ...
                        <p class="text-muted">BRI Bank Virtual Accounts only accept transfers from BRI Bank accounts. For
                          payments with a BRI
                          Syariah Bank account, use a Bank Mandiri virtual account. The following are transfer
                          instructions if
                          you use Bank BRI.</p>
                      </div>
                          ...
                          <div id="atm" class="collapse" aria-labelledby="headingOne" data-bs-parent="#accordionPetunjuk">
                            <div class="t-p">
                              <ol>
                                ...
                                <li>Double-check the information on the screen. Make sure the Merchant is Shopee, the
                                  total
                          ...
                          <div id="e-banking" class="collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="t-p">
                              <ol>
                                ...
                                <li>Select the original account, then select Fill in Pay Code and enter the Pay Code
                                  listed on
                                  the Payment page (consisting of 3 (three) Bank code numbers + User mobile number/random
                                  number) and select Send.</li>
                                <li>Check the information on the screen. Make sure the Merchant is Shopee, the total bill
                                  is
                                  correct, and your username is {username}. If it is correct, enter your E-Banking
                                  Password
                            ...
                            <div class="t-p">
                              <ol>
                                ...
                                <li>Enter your PIN > select Send. If a confirmation message appears for transactions using
                                  SMS, select OK. Transaction status will be sent via SMS and can be used as proof of
                                  payment.
                                </li>
                              </ol>
                            </div>
            ...
            <div class="p-3 bg-light bg-opacity-10">
              ...
              <div class="form-group small mb-3">
                Make sure you really understand the order you make. If you want to get more information please contact <a
                  class="link-danger"
                  href="https://wa.me/6281230451084?text=Saya%20ingin%20menanyakan%20detail%20terkait%20product%20anda"
